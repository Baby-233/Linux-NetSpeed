...
不卸载内核版本
wget -N "https://github.000060000.xyz/tcpx.sh" --no-check-certificate && chmod +x tcpx.sh && ./tcpx.sh
卸载内核版本
wget -N "https://github.000060000.xyz/tcp.sh" --no-check-certificate && chmod +x tcp.sh && ./tcp.sh
